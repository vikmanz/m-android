package com.vikmanz.shpppro.presentation.ui.main.main_fragment.my_contacts_list.adapter
...
import com.vikmanz.shpppro.presentation.ui.main.main_fragment.my_contacts_list.adapter.utils.DiffUtilContactListItemComparator
import com.vikmanz.shpppro.presentation.ui.utils.extensions.setGone
import com.vikmanz.shpppro.presentation.ui.utils.extensions.setImageWithGlide
...
class ContactsAdapter(
    ...
    inner class ContactViewHolder(private val binding: OneContactItemBinding) :
        ...
        private fun bindDeleteIcon(contactState: ContactItem) = with(binding) {
        ...
        private fun bindContactInfo(contactState: ContactItem) = with(binding) {
        ...
        private fun decorateHolder(contactState: ContactItem) = with(binding) {
            if (isMultiselect) {
                root.backgroundTintList = multiselectColor
                checkboxOneContactMultiSelect.setVisible()
                checkboxOneContactMultiSelect.isChecked = contactState.isChecked
